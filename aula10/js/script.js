//fazer uma referencia ao body usando document.body
...
btn1.onclick = () => {
    ...
    document.getElementById("resultado").innerHTML+=`O resto da divisão é "mais ou menos" ${resto}<br>`
}
...
btn2.onclick= () =>{
    ...
    maiorValor(n,n.length,fx, exibir);
}
...
function maiorValor(arrNum, arrTm, fx){
    ...
    function fx(tm,rs){
        return `O tamanhdo do array é ${tm} e o maior valor é ${rs} `
}